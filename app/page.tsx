...
import { MessageCircleQuestion, Shield, ArrowRight, KeyRound } from 'lucide-react'
      ...
      <main className="container mx-auto px-4 py-16 sm:py-24 max-w-2xl">
        <section className="text-center mb-12">
          ...
          <p className="mt-4 text-base sm:text-lg text-muted-foreground max-w-lg mx-auto">
            Each community has its own space. Enter your invite code to ask questions and see answers.
          </p>
        </section>

        <form action={goToSpace} className="rounded-2xl border border-border/60 bg-card/60 backdrop-blur-xl p-6 sm:p-8">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button type="submit" size="lg" className="bg-gradient-to-r from-primary to-fuchsia-500 hover:opacity-90">
